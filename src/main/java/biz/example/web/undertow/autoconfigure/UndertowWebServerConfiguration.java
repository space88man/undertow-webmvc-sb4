...
/**
 * {@link Configuration} for an Undertow-based reactive or servlet web server.
 *
...
public class UndertowWebServerConfiguration {
	...
	UndertowWebServerFactoryCustomizer undertowWebServerFactoryCustomizer(Environment environment,
		...
		return new UndertowWebServerFactoryCustomizer(environment, serverProperties, this.undertowProperties);
	}

	@Bean
	@ConditionalOnThreading(Threading.VIRTUAL)
	UndertowVirtualThreadsWebServerFactoryCustomizer undertowVirtualThreadsWebServerFactoryCustomizer() {
		return new UndertowVirtualThreadsWebServerFactoryCustomizer();
	}
